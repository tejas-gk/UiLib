...
export default function Nft() {
    return (
        <div className='nft-body flex justify-center items-center   bg-[#0d1a2d] min-h-screen min-w-screen'>
            <div
    ...
    shadow-2xl '
            >
                ...
                <p className='text-xs font-medium text-gray-400 flex items-center pt-3 gap-1'>
                    <img
                        className='w-5 border rounded-full mr-2'
                        alt='avatar'
                        src={avatar}
                    />{' '}
                    Creation of{' '}
                    <a className='font-medium text-white'> Jules Wyvern </a>{' '}
                </p>
            </div>
        </div>
    );

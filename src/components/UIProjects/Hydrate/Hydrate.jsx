      ...
      <div className='container flex flex-col  p-8 w-[40%] max-w-2xl  justify-between shadow-2xl shadow-blue-400'>
          <div className='header flex flex-row justify-between w-full'>
              <div className='hamburger-menu flex  flex-col gap-1 '>
                <span className='one w-6 bg-white rounded-md h-1  block 
                  ' />
        ...
        <main className='items-center flex flex-col mt-10'>
          <div className="text-center text-white mb-2">
                    <h2>Today</h2>
                    <p className="text-2xl font-semibold tracking-widest">1.3l of 2l</p>
          </div>
          <FaCircle className='h-3 w-3 text-[#1797f7]'
            />
        <div className='image'>
          <img src="https://www.linkpicture.com/q/water.png"
            alt="Water bottle"
            className='h-48 w-auto'
          />
          </div>
          <button className='main-btn font-bold  px-8 py-4 rounded-full mt-8 w-[13rem]
          '>
            Drink Water
          </button>
        </main>
        </div>
        <footer className='mx-0  text-black bg-[#edf6fc] py-4 pl-4  w-[40%]  shadow-2xl shadow-blue-400   pb-8
        '>
        ...
        <div className='stats  mt-3 flex flex-row gap-16 justify-start items-center  text-[#1597fb] text pl-4
        '> 

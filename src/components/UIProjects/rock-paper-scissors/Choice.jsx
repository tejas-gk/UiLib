         ...
         >
           <HandIcons
             extraClass={`border-[1rem] 
              ${!playerChoice ? 'border-[#dc3b5b]' : playerChoice === 'rock' ? 'border-[#dc3b5b]' : playerChoice === 'paper' ? 'border-[#536df7]' : 'border-[#f7b536]'}
             `}
             images={!playerChoice ? images.circle : images[playerChoice]}
             val={playerChoice}

export default function ProfileCard() {
    return (
      ...
      ">
      <div className="flex flex-col items-center content-center justify-center min-h-screen text-lg text-center font-kumbh 
  ...
  <main className="overflow-hidden bg-white rounded-lg w-80">
    <img src="assets/profile-card-component-main/images/bg-pattern-card.svg" alt="background"/>
    
    <div className="relative flex items-center content-center justify-center">
      <img src="assets/profile-card-component-main/images/image-victor.jpg" className="absolute rounded-full ring-4 ring-white"  alt="avatar"/>
    </div>

    <div className="mt-16 mb-8">
      <h2 className="font-bold text-desaturated-blue">Victor Crest <span className="font-normal text-dark-gray">26</span></h2>

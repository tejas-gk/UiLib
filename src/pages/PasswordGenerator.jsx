...
export default function PasswordGenerator() {
    ...
    return (
        <div className='bg-[#111116] w-screen h-screen flex justify-center items-center flex-col'>
            <h2 className="text-[#676576] text-center my-3 text-lg">Password Generator</h2>
        <div className='w-[90%] max-w-[540px] mx-8 '>
				...
				<h1 id="password" className="text-[#E6E5EA]">
                    ...
                    <img src='/assets/password-generator/icon-copy.svg'
                        onClick={() => {
			...
			<div className="mt-5 p-5 bg-[#24232a]">
				<div className="flex flex-col justify-center">
					<div className="flex flex-row justify-between items-center  mb-5">
						...
						<h2  className="text-[#A4FFAF]">
							{passwordLength}
						</h2>
					</div>
                        <input onChange={handleRange} className="slider rounded-full h-4 w-full active:bg-red-400
					...
					<div className="flex flex-row justify-between items-center  mb-5 bg-[#18171f] mt-5 p-5  ">
						...
						<div className="flex items-center">
							<div className="flex items-center">
			                <div id="password-bars" className="w-3 h-7 border ml-2 border-[#e6e5ea]"></div>
			                <div id="password-bars" className="w-3 h-7 border ml-2 border-[#e6e5ea]"></div>
			                <div id="password-bars" className="w-3 h-7 border ml-2 border-[#e6e5ea]"></div>
			                <div id="password-bars" className="w-3 h-7 border ml-2 border-[#e6e5ea]"></div>
		                    </div>

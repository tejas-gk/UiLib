...
export default function InteractiveRating() {
  ...
  return (
      <div className='bg-[#141519] h-screen flex justify-center items-center
      '>
          {
              !isSubmitted ? (
                  ...
                  >
                      <div className='rounded-full  w-9 h-9 flex items-center justify-center md:w-12 md:h-12 bg-[#232f36] 
            '>
                  ...
                  tracking-widest hover:bg-white hover:text-[#fc7613]  transition ease-in-out md:text-[0.9375rem]">
                      ...
                      <div className="text-white mx-auto w-80  bg-[#1f252d] text-sm  rounded-2xl p-5 
                       md:w-[26rem] md:rounded-[3rem] md:p-9">
                          ...
                          <div className="text-[#fc7613] rounded-full text-center p-1 my-6 bg-[#2d3743]
